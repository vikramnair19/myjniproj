...
//	    }
		...
		//PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "MyPluginWithJNI.viewer");
//		makeActions();
//		hookContextMenu();
...
//				RegisterView.this.fillContextMenu(manager);
//			}
//		});
...
private void populateItem(TableItem item) {
    String stringContent = String.valueOf(content);
    item.setText(new String[] { "R0:", stringContent});
    content++;
    if (content > 'z')
      content = 'a';
